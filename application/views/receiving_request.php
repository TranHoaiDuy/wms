        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-success" href="<?php echo base_url(); ?>create-goods-issue"><i
                            class="fa fa-plus"></i> Tạo Phiếu Nhận</a>
                </div>
            </div>
        </div>
        <?php } ?>
            ...
            <div class="col-xs-12">
                <div class="box box-purple">
                    <div class="box-header">
                        ...
                        <div class="box-tools">
                            <form action="<?php echo base_url() ?>receiving-request" method="POST" id="searchList">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            ?>
                            <tr
                                onclick="window.location.href='<?php echo base_url() ?>receiving-request/detail/<?php echo $issue->id ?>'">
                                <td><?php echo  date('Y-m-d', strtotime($issue->exportDtm)); ?></td>
                                <td><?php echo $issue->re_code; ?></td>
...
jQuery(document).ready(function() {
    jQuery('ul.pagination li a').click(function(e) {
        ...
        jQuery("#searchList").attr("action", baseURL + "receiving-request/" + value);
